sap.ui.define([
	...
	return Controller.extend("RiskManagementTwo.RiskMobile.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("RiskManagementTwo/RiskMobile/mdkindex.html?" + queryString);
